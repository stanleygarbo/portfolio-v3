    ...
    <Container id="about">
      <div className="wrapper">
        ...
        <div className="about-text">
          <h1>ABOUT ME</h1>
          <p>
            I am currently a senior high student at ACLC College of Ormoc. I
            build and develop websites according to your needs.
          </p>
      ...
      <div className="wrapper2">
        <section>
          <h1>MY PASSION</h1>
          <p>
            Ever since I started learning code I've become really interested to
            it which made me delve deeper into learning not just the basics but
            also some advanced frameworks associated with tech.
          </p>
        </section>
        <section>
          <h1>SKILL SETS</h1>
          <div className="icons">
            ...
            <img
              alt="TS icon"
              src="https://icons-for-free.com/iconfiles/png/512/vscode+icons+type+typescript-1324451507894042344.png"
            ></img>
